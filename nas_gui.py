...
class NasGui(QMainWindow):
    def __init__(self):
        ...
        self.root_input.setPlaceholderText("e.g. /home/jerry/workspace")
        self.root_input.setText("") 
        ...
        self.pass_input.setPlaceholderText("Enter a secure NAS password")
